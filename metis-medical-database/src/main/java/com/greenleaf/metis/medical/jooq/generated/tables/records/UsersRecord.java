...
public class UsersRecord extends UpdatableRecordImpl<UsersRecord> implements Record4<String, String, Boolean, Short> {

    private static final long serialVersionUID = 1320484923;
     ...
     */
    @Override
    public UsersRecord values(String value1, String value2, Boolean value3, Short value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public UsersRecord(String username, String password, Boolean enabled, Short specialtyId) {
        super(Users.USERS);

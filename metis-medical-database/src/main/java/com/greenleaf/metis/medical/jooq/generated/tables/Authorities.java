...
public class Authorities extends TableImpl<AuthoritiesRecord> {
    ...
    private static final long serialVersionUID = 1695313641;
     ...
     */
    public final TableField<AuthoritiesRecord, String> USERNAME = createField("username", org.jooq.impl.SQLDataType.VARCHAR(100).nullable(false), this, "");

    /**
     * The column <code>public.authorities.authority</code>.
     */
    public final TableField<AuthoritiesRecord, String> AUTHORITY = createField("authority", org.jooq.impl.SQLDataType.VARCHAR(50), this, "");
    ...
    public List<UniqueKey<AuthoritiesRecord>> getKeys() {
        return Arrays.<UniqueKey<AuthoritiesRecord>>asList(Keys.IX_AUTH_USERNAME);
    }
    ...
    public List<ForeignKey<AuthoritiesRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<AuthoritiesRecord, ?>>asList(Keys.AUTHORITIES__FK_AUTH_USR);
    }

    public Users users() {
        return new Users(this, Keys.AUTHORITIES__FK_AUTH_USR);
    }
